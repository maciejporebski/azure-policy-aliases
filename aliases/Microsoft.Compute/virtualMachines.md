...
| `properties.instanceView` | `Microsoft.Compute/virtualMachines/instanceView` |
| `properties.instanceView.platformUpdateDomain` | `Microsoft.Compute/virtualMachines/instanceView.platformUpdateDomain` |
| `properties.instanceView.platformFaultDomain` | `Microsoft.Compute/virtualMachines/instanceView.platformFaultDomain` |
| `properties.instanceView.rdpThumbPrint` | `Microsoft.Compute/virtualMachines/instanceView.rdpThumbPrint` |
| `properties.instanceView.vmAgent` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent` |
| `properties.instanceView.vmAgent.vmAgentVersion` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.vmAgentVersion` |
| `properties.instanceView.vmAgent.extensionHandlers` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.extensionHandlers` |
| `properties.instanceView.vmAgent.extensionHandlers[*]` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.extensionHandlers[*]` |
| `properties.instanceView.vmAgent.extensionHandlers[*].type` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.extensionHandlers[*].type` |
| `properties.instanceView.vmAgent.extensionHandlers[*].typeHandlerVersion` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.extensionHandlers[*].typeHandlerVersion` |
| `properties.instanceView.vmAgent.extensionHandlers[*].status` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.extensionHandlers[*].status` |
| `properties.instanceView.vmAgent.statuses` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses` |
| `properties.instanceView.vmAgent.statuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*]` |
| `properties.instanceView.vmAgent.statuses[*].code` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*].code` |
| `properties.instanceView.vmAgent.statuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*].level` |
| `properties.instanceView.vmAgent.statuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*].displayStatus` |
| `properties.instanceView.vmAgent.statuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*].message` |
| `properties.instanceView.vmAgent.statuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.vmAgent.statuses[*].time` |
| `properties.instanceView.disks` | `Microsoft.Compute/virtualMachines/instanceView.disks` |
| `properties.instanceView.disks[*]` | `Microsoft.Compute/virtualMachines/instanceView.disks[*]` |
| `properties.instanceView.disks[*].name` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].name` |
| `properties.instanceView.disks[*].statuses` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses` |
| `properties.instanceView.disks[*].statuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses[*]` |
| `properties.instanceView.disks[*].statuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses[*].level` |
| `properties.instanceView.disks[*].statuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses[*].displayStatus` |
| `properties.instanceView.disks[*].statuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses[*].message` |
| `properties.instanceView.disks[*].statuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].statuses[*].time` |
| `properties.instanceView.extensions` | `Microsoft.Compute/virtualMachines/instanceView.extensions` |
| `properties.instanceView.extensions[*]` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*]` |
| `properties.instanceView.extensions[*].name` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].name` |
| `properties.instanceView.extensions[*].type` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].type` |
| `properties.instanceView.extensions[*].typeHandlerVersion` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].typeHandlerVersion` |
| `properties.instanceView.extensions[*].substatuses` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses` |
| `properties.instanceView.extensions[*].substatuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*]` |
| `properties.instanceView.extensions[*].substatuses[*].code` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*].code` |
| `properties.instanceView.extensions[*].substatuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*].level` |
| `properties.instanceView.extensions[*].substatuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*].displayStatus` |
| `properties.instanceView.extensions[*].substatuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*].message` |
| `properties.instanceView.extensions[*].substatuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].substatuses[*].time` |
| `properties.instanceView.extensions[*].statuses` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses` |
| `properties.instanceView.extensions[*].statuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*]` |
| `properties.instanceView.extensions[*].statuses[*].code` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*].code` |
| `properties.instanceView.extensions[*].statuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*].level` |
| `properties.instanceView.extensions[*].statuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*].displayStatus` |
| `properties.instanceView.extensions[*].statuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*].message` |
| `properties.instanceView.extensions[*].statuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.extensions[*].statuses[*].time` |
| `properties.instanceView.bootDiagnostics` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics` |
| `properties.instanceView.bootDiagnostics.consoleScreenshotBlobUri` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.consoleScreenshotBlobUri` |
| `properties.instanceView.bootDiagnostics.serialConsoleLogBlobUri` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.serialConsoleLogBlobUri` |
| `properties.instanceView.statuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.statuses[*]` |
| `properties.instanceView.statuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.statuses[*].level` |
| `properties.instanceView.statuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.statuses[*].displayStatus` |
| `properties.instanceView.statuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.statuses[*].message` |
| `properties.instanceView.statuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.statuses[*].time` |
| `properties.instanceView.maintenanceRedeployStatus` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus` |
| `properties.instanceView.maintenanceRedeployStatus.isCustomerInitiatedMaintenanceAllowed` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.isCustomerInitiatedMaintenanceAllowed` |
| `properties.instanceView.maintenanceRedeployStatus.preMaintenanceWindowStartTime` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.preMaintenanceWindowStartTime` |
| `properties.instanceView.maintenanceRedeployStatus.preMaintenanceWindowEndTime` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.preMaintenanceWindowEndTime` |
| `properties.instanceView.maintenanceRedeployStatus.maintenanceWindowStartTime` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.maintenanceWindowStartTime` |
| `properties.instanceView.maintenanceRedeployStatus.maintenanceWindowEndTime` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.maintenanceWindowEndTime` |
| `properties.instanceView.maintenanceRedeployStatus.lastOperationResultCode` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.lastOperationResultCode` |
| `properties.instanceView.maintenanceRedeployStatus.lastOperationMessage` | `Microsoft.Compute/virtualMachines/instanceView.maintenanceRedeployStatus.lastOperationMessage` |
| `properties.instanceView.disks[*].encryptionSettings` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].encryptionSettings` |
| `properties.instanceView.disks[*].encryptionSettings[*]` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].encryptionSettings[*]` |
| `properties.instanceView.disks[*].encryptionSettings[*].diskEncryptionKey` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].encryptionSettings[*].diskEncryptionKey` |
| `properties.instanceView.disks[*].encryptionSettings[*].keyEncryptionKey` | `Microsoft.Compute/virtualMachines/instanceView.disks[*].encryptionSettings[*].keyEncryptionKey` |
| `properties.instanceView.computerName` | `Microsoft.Compute/virtualMachines/instanceView.computerName` |
| `properties.instanceView.osVersion` | `Microsoft.Compute/virtualMachines/instanceView.osVersion` |
| `properties.instanceView.bootDiagnostics.status` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status` |
| `properties.instanceView.bootDiagnostics.status.code` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status.code` |
| `properties.instanceView.bootDiagnostics.status.level` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status.level` |
| `properties.instanceView.bootDiagnostics.status.displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status.displayStatus` |
| `properties.instanceView.bootDiagnostics.status.message` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status.message` |
| `properties.instanceView.bootDiagnostics.status.time` | `Microsoft.Compute/virtualMachines/instanceView.bootDiagnostics.status.time` |
| `properties.instanceView.hyperVGeneration` | `Microsoft.Compute/virtualMachines/instanceView.hyperVGeneration` |
| `properties.instanceView.vmHealth` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth` |
| `properties.instanceView.vmHealth.status` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status` |
| `properties.instanceView.vmHealth.status.code` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status.code` |
| `properties.instanceView.vmHealth.status.level` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status.level` |
| `properties.instanceView.vmHealth.status.displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status.displayStatus` |
| `properties.instanceView.vmHealth.status.message` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status.message` |
| `properties.instanceView.vmHealth.status.time` | `Microsoft.Compute/virtualMachines/instanceView.vmHealth.status.time` |
| `properties.instanceView.assignedHost` | `Microsoft.Compute/virtualMachines/instanceView.assignedHost` |
| `properties.instanceView.patchStatus` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus` |
| `properties.instanceView.patchStatus.availablePatchSummary` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary` |
| `properties.instanceView.patchStatus.availablePatchSummary.status` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.status` |
| `properties.instanceView.patchStatus.availablePatchSummary.assessmentActivityId` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.assessmentActivityId` |
| `properties.instanceView.patchStatus.availablePatchSummary.rebootPending` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.rebootPending` |
| `properties.instanceView.patchStatus.availablePatchSummary.criticalAndSecurityPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.criticalAndSecurityPatchCount` |
| `properties.instanceView.patchStatus.availablePatchSummary.otherPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.otherPatchCount` |
| `properties.instanceView.patchStatus.availablePatchSummary.startTime` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.startTime` |
| `properties.instanceView.patchStatus.availablePatchSummary.lastModifiedTime` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.lastModifiedTime` |
| `properties.instanceView.patchStatus.availablePatchSummary.error` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.availablePatchSummary.error` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.status` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.status` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.installationActivityId` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.installationActivityId` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.maintenanceWindowExceeded` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.maintenanceWindowExceeded` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.rebootStatus` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.rebootStatus` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.notSelectedPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.notSelectedPatchCount` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.excludedPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.excludedPatchCount` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.pendingPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.pendingPatchCount` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.installedPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.installedPatchCount` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.failedPatchCount` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.failedPatchCount` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.startTime` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.startTime` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.lastModifiedTime` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.lastModifiedTime` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.startedBy` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.startedBy` |
| `properties.instanceView.patchStatus.lastPatchInstallationSummary.error` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.lastPatchInstallationSummary.error` |
| `properties.instanceView.patchStatus.configurationStatuses` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses` |
| `properties.instanceView.patchStatus.configurationStatuses[*]` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*]` |
| `properties.instanceView.patchStatus.configurationStatuses[*].code` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*].code` |
| `properties.instanceView.patchStatus.configurationStatuses[*].level` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*].level` |
| `properties.instanceView.patchStatus.configurationStatuses[*].displayStatus` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*].displayStatus` |
| `properties.instanceView.patchStatus.configurationStatuses[*].message` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*].message` |
| `properties.instanceView.patchStatus.configurationStatuses[*].time` | `Microsoft.Compute/virtualMachines/instanceView.patchStatus.configurationStatuses[*].time` |
| `properties.instanceView.isVMInStandbyPool` | `Microsoft.Compute/virtualMachines/instanceView.isVMInStandbyPool` |
