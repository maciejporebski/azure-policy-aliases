...
| `properties.networkAcls.ipv6Rules` | `Microsoft.Storage/storageAccounts/networkAcls.ipv6Rules` |
| `properties.networkAcls.ipv6Rules[*]` | `Microsoft.Storage/storageAccounts/networkAcls.ipv6Rules[*]` |
| `properties.networkAcls.ipv6Rules[*].value` | `Microsoft.Storage/storageAccounts/networkAcls.ipv6Rules[*].value` |
| `properties.networkAcls.ipv6Rules[*].action` | `Microsoft.Storage/storageAccounts/networkAcls.ipv6Rules[*].action` |
| `properties.dualStackEndpointPreference` | `Microsoft.Storage/storageAccounts/dualStackEndpointPreference` |
| `properties.dualStackEndpointPreference.publishIpv6Endpoint` | `Microsoft.Storage/storageAccounts/dualStackEndpointPreference.publishIpv6Endpoint` |
| `properties.primaryEndpoints.ipv6Endpoints` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints` |
| `properties.primaryEndpoints.ipv6Endpoints.blob` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.blob` |
| `properties.primaryEndpoints.ipv6Endpoints.queue` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.queue` |
| `properties.primaryEndpoints.ipv6Endpoints.table` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.table` |
| `properties.primaryEndpoints.ipv6Endpoints.file` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.file` |
| `properties.primaryEndpoints.ipv6Endpoints.web` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.web` |
| `properties.primaryEndpoints.ipv6Endpoints.dfs` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.dfs` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.blob` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.blob` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.queue` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.queue` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.table` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.table` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.file` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.file` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.web` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.web` |
| `properties.primaryEndpoints.ipv6Endpoints.microsoftEndpoints.dfs` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.microsoftEndpoints.dfs` |
| `properties.primaryEndpoints.ipv6Endpoints.internetEndpoints` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.internetEndpoints` |
| `properties.primaryEndpoints.ipv6Endpoints.internetEndpoints.blob` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.internetEndpoints.blob` |
| `properties.primaryEndpoints.ipv6Endpoints.internetEndpoints.file` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.internetEndpoints.file` |
| `properties.primaryEndpoints.ipv6Endpoints.internetEndpoints.web` | `Microsoft.Storage/storageAccounts/primaryEndpoints.ipv6Endpoints.internetEndpoints.web` |
