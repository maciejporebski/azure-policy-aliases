...
| `properties.routing` | `Microsoft.CognitiveServices/accounts/deployments/routing` |
| `properties.routing.mode` | `Microsoft.CognitiveServices/accounts/deployments/routing.mode` |
| `properties.routing.models` | `Microsoft.CognitiveServices/accounts/deployments/routing.models` |
| `properties.routing.models[*]` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*]` |
| `properties.routing.models[*].publisher` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].publisher` |
| `properties.routing.models[*].format` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].format` |
| `properties.routing.models[*].name` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].name` |
| `properties.routing.models[*].version` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].version` |
| `properties.routing.models[*].source` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].source` |
| `properties.routing.models[*].sourceAccount` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].sourceAccount` |
| `properties.routing.models[*].callRateLimit` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].callRateLimit` |
| `properties.routing.models[*].callRateLimit.count` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].callRateLimit.count` |
| `properties.routing.models[*].callRateLimit.renewalPeriod` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].callRateLimit.renewalPeriod` |
| `properties.routing.models[*].callRateLimit.rules` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].callRateLimit.rules` |
| `properties.routing.models[*].callRateLimit.rules[*]` | `Microsoft.CognitiveServices/accounts/deployments/routing.models[*].callRateLimit.rules[*]` |
| `properties.speculativeDecoding` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding` |
| `properties.speculativeDecoding.draftModel` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel` |
| `properties.speculativeDecoding.draftModel.publisher` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.publisher` |
| `properties.speculativeDecoding.draftModel.format` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.format` |
| `properties.speculativeDecoding.draftModel.name` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.name` |
| `properties.speculativeDecoding.draftModel.version` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.version` |
| `properties.speculativeDecoding.draftModel.source` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.source` |
| `properties.speculativeDecoding.draftModel.sourceAccount` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.sourceAccount` |
| `properties.speculativeDecoding.draftModel.callRateLimit` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.callRateLimit` |
| `properties.speculativeDecoding.draftModel.callRateLimit.count` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.callRateLimit.count` |
| `properties.speculativeDecoding.draftModel.callRateLimit.renewalPeriod` | `Microsoft.CognitiveServices/accounts/deployments/speculativeDecoding.draftModel.callRateLimit.renewalPeriod` |
