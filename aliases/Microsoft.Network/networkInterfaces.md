...
| `properties.networkSecurityGroup.properties.defaultSecurityRules[*].id` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.defaultSecurityRules[*].id` |
| `properties.networkSecurityGroup.properties.subnets[*].id` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.subnets[*].id` |
| `properties.ipConfigurations[*].properties.publicIPAddress.name` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].publicIPAddress.name` |
| `properties.ipConfigurations[*].properties.publicIPAddress.type` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].publicIPAddress.type` |
| `properties.ipConfigurations[*].properties.publicIPAddress.location` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].publicIPAddress.location` |
| `properties.ipConfigurations[*].properties.publicIPAddress.tags` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].publicIPAddress.tags` |
| `properties.ipConfigurations[*].properties.applicationSecurityGroups[*].name` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].applicationSecurityGroups[*].name` |
| `properties.ipConfigurations[*].properties.applicationSecurityGroups[*].type` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].applicationSecurityGroups[*].type` |
| `properties.ipConfigurations[*].properties.applicationSecurityGroups[*].location` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].applicationSecurityGroups[*].location` |
| `properties.ipConfigurations[*].properties.applicationSecurityGroups[*].tags` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].applicationSecurityGroups[*].tags` |
| `properties.ipConfigurations[*].properties.virtualNetworkTaps[*].id` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].virtualNetworkTaps[*].id` |
| `properties.ipConfigurations[*].properties.virtualNetworkTaps[*].name` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].virtualNetworkTaps[*].name` |
| `properties.ipConfigurations[*].properties.virtualNetworkTaps[*].type` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].virtualNetworkTaps[*].type` |
| `properties.ipConfigurations[*].properties.virtualNetworkTaps[*].location` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].virtualNetworkTaps[*].location` |
| `properties.ipConfigurations[*].properties.virtualNetworkTaps[*].tags` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].virtualNetworkTaps[*].tags` |
| `properties.networkSecurityGroup.properties.flowLogs[*].id` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.flowLogs[*].id` |
| `properties.networkSecurityGroup.properties.flowLogs[*].name` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.flowLogs[*].name` |
| `properties.networkSecurityGroup.properties.flowLogs[*].type` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.flowLogs[*].type` |
| `properties.networkSecurityGroup.properties.flowLogs[*].location` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.flowLogs[*].location` |
| `properties.networkSecurityGroup.properties.flowLogs[*].tags` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.flowLogs[*].tags` |
| `properties.networkSecurityGroup.properties.networkInterfaces[*].extendedLocation` | `Microsoft.Network/networkInterfaces/networkSecurityGroup.networkInterfaces[*].extendedLocation` |
| `properties.ipConfigurations[*].properties.publicIPAddress.extendedLocation` | `Microsoft.Network/networkInterfaces/ipConfigurations[*].publicIPAddress.extendedLocation` |
| `properties.privateLinkService.properties.loadBalancerFrontendIpConfigurations[*].id` | `Microsoft.Network/networkInterfaces/privateLinkService.loadBalancerFrontendIpConfigurations[*].id` |
| `properties.privateLinkService.properties.ipConfigurations[*].id` | `Microsoft.Network/networkInterfaces/privateLinkService.ipConfigurations[*].id` |
| `properties.privateLinkService.properties.networkInterfaces[*].id` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].id` |
| `properties.privateLinkService.properties.networkInterfaces[*].name` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].name` |
| `properties.privateLinkService.properties.networkInterfaces[*].type` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].type` |
| `properties.privateLinkService.properties.networkInterfaces[*].location` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].location` |
| `properties.privateLinkService.properties.networkInterfaces[*].tags` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].tags` |
| `properties.privateLinkService.properties.networkInterfaces[*].extendedLocation` | `Microsoft.Network/networkInterfaces/privateLinkService.networkInterfaces[*].extendedLocation` |
| `properties.privateLinkService.properties.privateEndpointConnections[*].id` | `Microsoft.Network/networkInterfaces/privateLinkService.privateEndpointConnections[*].id` |
| `properties.privateEndpoint.properties.applicationSecurityGroups[*].id` | `Microsoft.Network/networkInterfaces/privateEndpoint.applicationSecurityGroups[*].id` |
| `properties.privateEndpoint.properties.applicationSecurityGroups[*].name` | `Microsoft.Network/networkInterfaces/privateEndpoint.applicationSecurityGroups[*].name` |
| `properties.privateEndpoint.properties.applicationSecurityGroups[*].type` | `Microsoft.Network/networkInterfaces/privateEndpoint.applicationSecurityGroups[*].type` |
