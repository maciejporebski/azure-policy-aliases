...
| `properties.routingRules[*].properties.patternsToMatch` | `Microsoft.Network/frontdoors/routingRules[*].patternsToMatch` |
| `properties.routingRules[*].properties.customForwardingPath` | `Microsoft.Network/frontdoors/routingRules[*].customForwardingPath` |
| `properties.routingRules[*].properties.forwardingProtocol` | `Microsoft.Network/frontdoors/routingRules[*].forwardingProtocol` |
| `properties.routingRules[*].properties.cacheConfiguration.queryParameterStripDirective` | `Microsoft.Network/frontdoors/routingRules[*].cacheConfiguration.queryParameterStripDirective` |
| `properties.routingRules[*].properties.cacheConfiguration.dynamicCompression` | `Microsoft.Network/frontdoors/routingRules[*].cacheConfiguration.dynamicCompression` |
| `properties.routingRules[*].properties.cacheConfiguration` | `Microsoft.Network/frontdoors/routingRules[*].cacheConfiguration` |
| `properties.routingRules[*].properties.backendPool.id` | `Microsoft.Network/frontdoors/routingRules[*].backendPool.id` |
| `properties.routingRules[*].properties.backendPool` | `Microsoft.Network/frontdoors/routingRules[*].backendPool` |
