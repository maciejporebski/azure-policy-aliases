...
| `properties.outboundVnetRouting.imagePullTraffic` | `Microsoft.Web/sites/slots/vnetImagePullEnabled` |
...
| `properties.ipMode` | `Microsoft.Web/sites/slots/ipMode` |
| `properties.autoGeneratedDomainNameLabelScope` | `Microsoft.Web/sites/slots/autoGeneratedDomainNameLabelScope` |
| `properties.sku` | `Microsoft.Web/sites/slots/sku` |
| `properties.outboundVnetRouting` | `Microsoft.Web/sites/slots/outboundVnetRouting` |
| `properties.outboundVnetRouting.allTraffic` | `Microsoft.Web/sites/slots/outboundVnetRouting.allTraffic` |
| `properties.outboundVnetRouting.applicationTraffic` | `Microsoft.Web/sites/slots/outboundVnetRouting.applicationTraffic` |
| `properties.outboundVnetRouting.contentShareTraffic` | `Microsoft.Web/sites/slots/outboundVnetRouting.contentShareTraffic` |
| `properties.outboundVnetRouting.imagePullTraffic` | `Microsoft.Web/sites/slots/outboundVnetRouting.imagePullTraffic` |
| `properties.outboundVnetRouting.backupRestoreTraffic` | `Microsoft.Web/sites/slots/outboundVnetRouting.backupRestoreTraffic` |
| `properties.siteConfig.http20ProxyFlag` | `Microsoft.Web/sites/slots/siteConfig.http20ProxyFlag` |
