...
| `properties.outboundVnetRouting.imagePullTraffic` | `Microsoft.Web/sites/vnetImagePullEnabled` |
...
| `properties.ipMode` | `Microsoft.Web/sites/ipMode` |
| `properties.autoGeneratedDomainNameLabelScope` | `Microsoft.Web/sites/autoGeneratedDomainNameLabelScope` |
| `properties.sku` | `Microsoft.Web/sites/sku` |
| `properties.outboundVnetRouting` | `Microsoft.Web/sites/outboundVnetRouting` |
| `properties.outboundVnetRouting.allTraffic` | `Microsoft.Web/sites/outboundVnetRouting.allTraffic` |
| `properties.outboundVnetRouting.applicationTraffic` | `Microsoft.Web/sites/outboundVnetRouting.applicationTraffic` |
| `properties.outboundVnetRouting.contentShareTraffic` | `Microsoft.Web/sites/outboundVnetRouting.contentShareTraffic` |
| `properties.outboundVnetRouting.imagePullTraffic` | `Microsoft.Web/sites/outboundVnetRouting.imagePullTraffic` |
| `properties.outboundVnetRouting.backupRestoreTraffic` | `Microsoft.Web/sites/outboundVnetRouting.backupRestoreTraffic` |
| `properties.siteConfig.http20ProxyFlag` | `Microsoft.Web/sites/siteConfig.http20ProxyFlag` |
